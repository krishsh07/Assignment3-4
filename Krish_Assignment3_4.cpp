...
int main()
{
    Person person1;
    Person person2;
    person1.setPersonAge(7);
    person2.setPersonContactInfo(9898234719);

    Student Student1;
    Student Student2;
    Student1.getPersonAgeID();
    Student2.setPersonAge(22);
...
void testAssistantFunctionality()
{
    ...
    gradStudent->setPersonName("krish");
